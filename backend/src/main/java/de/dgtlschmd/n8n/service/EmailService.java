...
public class EmailService {
    ...
    @Value("${mail.from:noreply@n8n-manager.local}")
    private String mailFrom;

    @Value("${mail.from-name:N8N Instance Manager}")
    private String mailFromName;

    @Value("${app.email.locale:de_DE}")
    private String emailLocale;

    @Value("${app.email.branding:nim}")
     ...
     */
    private String loadEmailTemplate(String username, String resetUrl) throws IOException {
    ...
    private String getFallbackTemplate(String username, String resetUrl) {
        return "<!DOCTYPE html>" +
                ...
                "<p>Mit freundlichen Grüßen,<br>Ihr N8N Instance Manager Team</p>" +
                "</body></html>";
    }
